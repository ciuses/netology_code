...
CREATE TABLE IF NOT EXISTS genres_artists (
	...
	CONSTRAINT pk_genres_artists PRIMARY KEY (genres_id,
artists_id)
);
...
CREATE TABLE IF NOT EXISTS artists_albums (
	...
	CONSTRAINT pk_artists_albums PRIMARY KEY (artists_id,
album_id)
);
...
CREATE TABLE IF NOT EXISTS tracks_collection (
	...
	CONSTRAINT pk_tracks_collection PRIMARY KEY (tracks_id,
collection_id)
);
